...
import { ArbitrumStipGranteeDocument } from '../../gen/types';
import {
    createContext,
    expectException,
    expectNoException,
...
import { toArray } from '../../../../editors/arb-stip/util';
...
describe('General Operations', () => {
    let document: ArbitrumStipGranteeDocument;
    ...
    it('initGrantee should deny invalid formatting for muStiple funding addresses', () => {
        document.state.global.authorizedSignerAddress = '';
    ...
    it('initGrantee should allow properly formatted muStiple funding addresseses', () => {
        document.state.global.authorizedSignerAddress = '';
